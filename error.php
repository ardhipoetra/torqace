				...
				<tr>
					...
					style="text-align: left; height: 100%; width: 90%; margin-left: auto; margin-right: auto;">
						<tbody>
							<tr>
								<td
								style="text-align: center; vertical-align: top; height: 20%;">
								<br>
								<big><big><big><big><span
												style="color: rgb(153, 0, 0);">An Error Just Happened.
													<br>
							...
							<tr>
								...
								<div style="margin-left: 80px;">
									<big><big><small>
												<br>
												<?php print($string); ?></small>
											<br>
										</big></big>
								</div></td>
							</tr>
							<tr>
								<td style="vertical-align: middle;"> Send questions and comments to <?php
