	...
	<?php 
		...
		if (strcmp($owner, $username)) {
			...
			<table width=90% border=1>
				<tr>
					<th>Job ID</th>
					<td><?php echo $xml->Job[0]->Job_Id; ?></td>
				</tr>
				<tr>
					<th>Job Name</th>
					<td><?php echo $xml->Job[0]->Job_Name; ?></td>
				</tr>
				<tr>
					<th>Job State</th>
					<td><?php 
						$state = $xml->Job[0]->job_state;
						switch ($state) {
							case 'R':
								echo "Running";
								break;
				...
				<tr>
					<th>Queue</th>
					<td><?php echo $xml->Job[0]->queue; ?></td>
				</tr>
				<tr>
				<?php 
					$arr = explode("+", $xml->Job[0]->exec_host); 
					$size = (sizeof($arr)+1)/2;
				...
				<tr>
					...
					<th>Need Nodes</th>
					<td><?php echo $xml->Job[0]->Resource_List->nodes; ?></td>
				</tr>
				<tr>
					<th>Walltime</th>
					<td><?php echo $xml->Job[0]->Resource_List->walltime; ?></td>
				</tr>
				<tr>
					<th>Created Time</th>
					<td><?php echo date(DATE_RFC850,intval($xml->Job[0]->ctime)); ?></td>
				</tr>
				<tr>
					<th>Queued Time</th>
					<td><?php echo date(DATE_RFC850,intval($xml->Job[0]->etime)); ?></td>
				</tr>
				<tr>
					<th>Started Time</th>
					<td><?php echo 
				...
				<tr>
					<th>Priority</th>
					<td><?php echo $xml->Job[0]->Priority; ?></td>
				</tr>
				<tr>
					<th>Submitted Script</th>
					<td><?php echo $xml->Job[0]->submit_args; ?></td>
				</tr>
				<tr>
					<th>Remaining Walltime</th>
					<td><?php echo $xml->Job[0]->Walltime->Remaining; ?></td>
				</tr>
				<tr>
					<th>Working Directory</th>
					<td><?php $wd = explode("/",$xml->Job[0]->init_work_dir); echo $wd[4];?></td>
				</tr>
				<tr>
					<th>Mail to : </th>
					<td><?php echo $xml->Job[0]->Mail_Users; ?></td>
				</tr>
				<!-- <tr>
					<th>Job ID</th>
					<td><?php ?></td>
